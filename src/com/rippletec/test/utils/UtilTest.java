...
//	sms.send("15622739759", "123456","1");
	...
	System.out.println(EmailUtil.sendEmail("860986808@qq.com" ,StringUtil.RegisterContent("860766334@qq.com", "12345"), "你最近怎样？"));
    }
	...
	String data = "【制剂与规格】盐酸丁卡因注射液：（1)3mL:30mg。（2)5mL:50mg。 (3)10mL:30mg。贮法：密闭保存注射用盐酸丁卡因：（1)10mg。 (2)15mg。（3)20mg。（4)25mg。(5)50mgp贮法：遮光，密闭保存。盐酸丁卡因滴眼液 0.5%。盐酸丁卡因眼膏 0.5%。盐酸丁卡因软膏 0.5%。盐酸丁卡因乳膏 1%。盐酸丁卡因溶液 （1)2mL:40mg。（2)5mL:50mg。盐酸丁卡因片 10mg。1贮法：遮光，密闭保存。盐酸丁卡因凝胶  1.5g:70mg。贮法：15℃以下避光贮藏，不能暴露或冷冻。";
