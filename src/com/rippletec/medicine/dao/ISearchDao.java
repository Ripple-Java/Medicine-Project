...
public interface ISearchDao<T> {
     ...
     * @return
     */
    List<T> search(Map<String, Object> paramMap);
     ...
     * @return
     */
    List<T> search(String param, Object value);
     ...
     * @return
     */
    List<T> search(String tableName, String field, Object keyword, String param, Object value);
     ...
     * @return
     */
    List<T> search(String tableName, Map<String, Object> fieldMap, Map<String, Object> paramMap);
}
